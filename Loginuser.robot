...
Verify the login scenario with the valid credentials
      ...
      Input Text    xpath://input[@data-qa='login-email']     sushi@gmail.com
      Click Element    xpath://input[@placeholder='Password']
      Input Text    xpath://input[@placeholder='Password']   sunil123
      Click Element    xpath://button[normalize-space()='Login']
      Wait Until Element Is Visible    xpath://li[10]//a[1]
      Wait Until Element Is Visible    xpath://a[normalize-space()='Logout']
